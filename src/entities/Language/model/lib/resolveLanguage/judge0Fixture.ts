...
/**
 * The exact list the deployed Judge0 returns, captured from the running
 * sandbox. Tests resolve against this rather than a tidied-up sample, so a
 * rule that only works on a hand-written list fails here.
 */
